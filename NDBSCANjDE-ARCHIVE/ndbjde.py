    ...
    def diferentialEvolution(self, pop_size, dim, max_iterations, runs, func, f, nfunc, accuracy, flag_plot, eps_value, archive_flag, maximize=True):
        ...
        for r in range(runs):
            ...
            for iteration in range(max_iterations):
                ...
                if dim == 2 and flag_plot == 1: #and (iteration == 1 or iteration == math.floor(max_iterations*0.25) or iteration == math.floor(max_iterations*0.50) or iteration == math.floor(max_iterations * 0.75)):
                    if iteration == 1:
                        sleep(7)
                    plt.xlim(lb, ub)
                    plt.ylim(lb, ub)
